...
ExecStart=${LLAMA_BINARY_DIR}/llama-server --model ${MODEL_DIR}/Qwen3.5-27B-Q8_0.gguf --host 127.0.0.1 --port ${LLAMA_PORT} --ctx-size 8192 --threads ${THREADS} --flash-attn on --chat-template chatml
